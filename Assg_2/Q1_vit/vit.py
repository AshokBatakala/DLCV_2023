...
class Tokenizer(nn.Module):
    ...
    def __init__(self, token_dim, patch_size,stride = None) :
...
class Multiheadselfattention(nn.Module):
    ...
    def __init__(self,token_dim, head_dim , n_heads , droupout_p ) :
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, token_dim, multihead_attention_head_dim, multihead_attention_n_heads,
                    multilayer_perceptron_hidden_dim, dropout_p) :
        super().__init__()
...
class Transformer(nn.Module):
    ...
    def __init__(self, n_attention_layers, token_dim, multihead_attention_head_dim, multihead_attention_n_heads,
                    mulitlayer_perceptron_hidden_dim, dropout_p) :
    ...
    def forward(self, input,return_cls_tokens_after_each_layer=False):
...
class visionTransformer(nn.Module):
    ...
    def __init__(self,  token_dim,
                        ...
                        image_size,
                        n_attention_layers,
                        multihead_attention_head_dim ,
                        multihead_attention_n_heads,
                        multilayer_perceptron_hidden_dim,
                        dropout_p, n_classes,
                        stride_in_tokenization = None):
